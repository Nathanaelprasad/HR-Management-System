                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class="text-right"><?php echo $addition[0]->basic; ?> Rs</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Madical Allowance</td>
                                                <td class="text-right"> <?php echo $addition[0]->medical; ?>  Rs</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class="text-right"><?php echo $addition[0]->house_rent; ?>  Rs</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Conveyance Allowance</td>
                                                <td class="text-right"><?php echo $addition[0]->conveyance; ?>  Rs</td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Bonus</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php
                                                        if($a > 0) { echo round($a,2).' Rs'; }
                                                    ?>
                                                </td>
                                                <td class="text-right">
                                                    <?php
                                                        if($d > 0) { echo round($d,2).' Rs'; }
                                                    ?>        
                                                </td>
                                                <td class="text-right"> </td>
                                            </tr>
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                ...
                                                <th class="text-right"><?php $total_did = $salary_info->loan+$salary_info->diduction; echo round($total_did,2); ?> Rs</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class="text-right">Net Pay</th>
                                                <th class="text-right"><?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?>Rs</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->basic;?> Rs</td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->medical;?> Rs</td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->house_rent;?> Rs </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> <?php echo $salaryvaluebyid->conveyance;?> Rs </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Loan</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right"><?php echo $salary_info->loan;?>  Rs</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Total</th>
                                                    <th class="text-right"><?php echo $salaryvaluebyid->total;?> Rs</th>
                                                    <th class="text-right"><?php echo $salary_info->diduction;?>  Rs</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Total :</b>  <?php echo $salary_info->total_pay;?> Rs</h3>
                                    </div>
